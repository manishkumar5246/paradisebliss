...
const heroImage = "/optimised/kasol-tosh-hero.webp"; // Hero background
const highlightImages = [
  "/optimised/chalal-village.webp",     // Chalal Village
  "/optimised/tosh-village.webp",       // Tosh Village
  "/optimised/tosh-waterfall.webp",     // Tosh Waterfall
  "/optimised/manikaran-gurudwara.webp",// Manikaran Gurudwara
];
const rightSideImage = "/img/logo.png";

// === QUICK FACTS ===
const quickFacts = [
  { text: "Tosh is a hidden gem at 7,900 ft, known for its hippie culture and stunning views." },
  { text: "The trek to Tosh is a moderate 2.5 km hike from Barshaini." },
  { text: "Chalal Village is a peaceful 3 km round-trip walk from Kasol." },
  { text: "Manikaran is famous for its natural hot springs and sacred Gurudwara." },
];
...
const itinerary = [
  {
    ...
    desc: "Evening: Depart from Delhi around 6:00 PM in an AC vehicle.\nOvernight: Travel overnight to Kasol."
  },
  {
    day: "Day 2",
    title: "Explore Kasol – Hike to Chalal Village",
    desc: "Morning: Arrive in Kasol.\nActivities:\n• Explore the vibrant Kasol Market.\n• Enjoy café hopping at popular spots like Evergreen Café and Jim Morrison Café.\n• Embark on a short hike to Chalal Village (3 km round trip).\nEvening: Return to Kasol.\nOvernight: Stay in Kasol."
  },
  {
    day: "Day 3",
    title: "Transfer to Tosh – Waterfall Trek – Return to Delhi",
    desc: "Morning: After breakfast, drive to Barshaini (2 hours).\nTrek: Begin the trek to Tosh Village (approximately 2.5 km).\nActivities:\n• Explore Tosh Village and its surroundings.\n• Visit the Tosh Waterfall.\n• Enjoy café hopping in Tosh.\nAfternoon: Drive back to Kasol.\nEvening: Visit the Manikaran Gurudwara and hot springs.\nNight: Depart from Kasol to Delhi."
  },
  {
    day: "Day 4",
...
// === HIGHLIGHTS ===
const highlights = [
  { title: "Chalal Village Hike", image: highlightImages[0], desc: "Peaceful 3 km round-trip trek through pine forests." },
  { title: "Tosh Village", image: highlightImages[1], desc: "Hippie haven with stunning mountain views." },
  { title: "Tosh Waterfall", image: highlightImages[2], desc: "Scenic waterfall near Tosh, perfect for photos." },
  { title: "Manikaran Hot Springs", image: highlightImages[3], desc: "Sacred site with geothermal springs and langar." },
];

// === FAQs (Trip-Specific) ===
const faqs = [
  { question: "Is the trek to Tosh difficult?", answer: "No, it's a moderate 2.5 km trek from Barshaini. Suitable for beginners with basic fitness." },
  { question: "What type of accommodation is provided?", answer: "1 night in a hotel in Kasol and 1 night in a cozy homestay in Tosh (Quad/Triple sharing only)." },
  { question: "Are meals vegetarian?", answer: "Yes, all meals are pure veg. Local Himachali and North Indian cuisine." },
  { question: "Is network available in Tosh?", answer: "Limited. Jio/Airtel works in Kasol. Tosh has patchy signal. Carry a power bank." },
  { question: "Can we extend stay in Tosh?", answer: "Yes, extendable at extra cost. Inform Team Captain in advance." },
  { question: "What should I pack?", answer: "Trekking shoes, warm jacket, sunscreen, water bottle, personal meds, power bank, and a light backpack." },
  { question: "Is the Volvo bus comfortable?", answer: "Yes, AC Volvo with push-back seats. Overnight journey from Delhi." },
  { question: "Are adventure activities included?", answer: "No, only the mentioned treks. Other activities like river rafting are extra." },
  { question: "Can kids join?", answer: "Yes, 8+ years. Family-friendly with moderate activity." },
  { question: "What is the best time to visit?", answer: "April–June & September–November. Avoid monsoon due to slippery trails." },
];
...
const importantInfo = [
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-1">
        <li><strong>Accommodation:</strong> 1 night in a hotel at Kasol and 1 night in a homestay at Tosh (Quad or Triple Sharing Only).</li>
        <li><strong>Meals:</strong> 4 meals – Breakfast (Day 1), Breakfast & Dinner (Day 2), Breakfast (Day 3).</li>
        <li><strong>Transportation:</strong> Volvo for Delhi–Delhi transportation, local surface transport from Kasol to Barshaini and back.</li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Follow Team Captain instructions during treks.</li>
        <li>Carry water and stay hydrated.</li>
        <li>Wear proper trekking shoes and warm clothes in Tosh.</li>
        <li>Do not litter — keep the mountains clean.</li>
...
export default function KasolToshTrekPackage() {
  ...
  const handleSubmit = useCallback((e) => {
    e.preventDefault();
    console.log('Kasol-Tosh Trek Booking:', formData);
    handleCloseModal();
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Escape to the serene <strong>Kasol</strong> and trek to the magical <strong>Tosh</strong> village. Experience café culture, short hikes, waterfalls, and the spiritual vibe of Manikaran in just 3 days!
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Route:</strong> Delhi → Kasol → Tosh → Delhi
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Trek:</strong> 2.5 km to Tosh
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Best For:</strong> Chill & Light Trek
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <Image
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">3-Day Kasol – Tosh Trek – Paradise Bliss</h3>
            </div>
