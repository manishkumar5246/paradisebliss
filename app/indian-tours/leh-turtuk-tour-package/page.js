...
// Quick Facts about Leh to Turtuk Adventure
const quickFacts = [
  { text: "Turtuk is India’s northernmost village, opened to tourists only in 2010." },
  { text: "Khardung La (17,582 ft) is one of the highest motorable roads in the world." },
  { text: "Hunder is famous for double-humped Bactrian camels in the cold desert." },
  { text: "Pangong Tso changes color 5–7 times a day due to light reflection." },
];

// Itinerary data - Updated for 7-Day Leh to Turtuk Tour
const itinerary = [
  {
    day: "Day 1",
...
// Highlights data - Updated for Leh to Turtuk
const highlights = [
  { title: "Khardung La Pass", image: highlightImages[0], desc: "Cross one of the highest motorable roads in the world." },
  { title: "Hunder Sand Dunes", image: highlightImages[1], desc: "Cold desert with double-humped camel rides." },
  { title: "Turtuk Village", image: highlightImages[2], desc: "India’s northernmost village with Balti culture." },
  { title: "Pangong Tso", image: highlightImages[3], desc: "Iconic high-altitude lake with surreal colors." },
];

// FAQ data - Tailored for Leh to Turtuk tour
const faqs = [
  { question: "Is Turtuk safe to visit?", answer: "Yes, it is completely safe and open for tourists. Inner Line Permit is required." },
  { question: "Do I need a permit for Turtuk?", answer: "Yes, included in the package. We handle all ILP applications." },
  { question: "Can I fly directly to Leh?", answer: "Yes, this is a fly-in-fly-out package. Arrival/departure via Leh Airport." },
  { question: "What is the best time to visit Turtuk?", answer: "June to September — roads are open, apricots are in season." },
  { question: "Is camel ride included?", answer: "No, it's optional and payable directly (approx. ₹400–600 per person)." },
  { question: "What type of accommodation is provided?", answer: "Comfortable hotels in Leh, deluxe camps in Nubra & Pangong (attached bathrooms)." },
  { question: "Is oxygen provided during the trip?", answer: "Yes, portable oxygen cylinders are carried for emergencies." },
  { question: "Are meals vegetarian?", answer: "Yes, all meals are veg. Non-veg can be arranged in Leh on request." },
  { question: "What is the group size?", answer: "Small groups of 6–12 travelers for personalized experience." },
  { question: "What is the cancellation policy?", answer: "Full refund minus fees if canceled 30+ days prior. No refund within 10 days." },
];

// Important Information data - Adapted for Leh to Turtuk
const importantInfo = [
  {
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <em>Batches: June to September | Fly-in-Fly-out from Leh</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Ideal for culture enthusiasts, photographers, and adventure lovers seeking offbeat Himalayan gems. From high passes to border villages — this is raw, authentic Ladakh.
      </p>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Leh and Nubra are at high altitude — acclimatize properly.</li>
        <li>Stay hydrated and avoid overexertion.</li>
        <li>Carry warm clothing, even in summer.</li>
        <li>ATMs are limited; carry sufficient cash.</li>
        <li>Respect local culture and photography rules at monasteries.</li>
      </ul>
    ),
  },
];
...
export default function LehToTurtukTour() {
    ...
    <div className="bg-[#F1FDF3] min-h-screen">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#00453A]/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              Paradise Bliss Tours – 7 Days of Borderland Wonders
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              The journey from Leh to Turtuk is one of Ladakh’s most breathtaking experiences — a blend of dramatic landscapes, high-altitude mountain passes, ancient monasteries, and remote villages that reflect the true soul of the Himalayas.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Route:</strong> Leh → Nubra → Turtuk → Pangong → Leh
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Offbeat, cultural, serene
              </li>
            </ul>
          </div>
      ...
      >
        <motion.h2
          ...
          transition={{ duration: 0.3 }}
          viewport={{ once: true }}
          className="text-4xl md:text-5xl font-bold text-[#00453A] text-center16 mb-12 font-serif relative"
        >
          Pricing & Details
          <span className="absolute left-1/2 transform -translate-x-1/2 bottom-0 w-16 h-1 bg-[#F5A623]"></span>
        </motion.h2>
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-600 mt-2 font-sans">June–Sept | Fly-in-Fly-out</p>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 6 nights hotels/camps</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Breakfast + dinner daily</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> SUV/Tempo + local driver</li>
          ...
          >
            ...
            <div className="mb-4">
              <Image
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Leh to Turtuk – 7 Days - Paradise Bliss Tours</h3>
            </div>
