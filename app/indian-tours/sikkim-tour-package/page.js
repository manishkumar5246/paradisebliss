...
// Sikkim Images (replace with actual paths)
const heroImage = "/img/sikkim-hero.jpg";
const highlightImages = [
  "/img/sikkim/gangtok.jpg",
  "/img/sikkim/tsomgo-lake.jpg",
  "/img/sikkim/yumthang.jpg",
  "/img/sikkim/rumtek.jpg",
];
const rightSideImage = "/img/sikkim/kanchenjunga.jpg";
...
// Trip Highlights
const highlights = [
  { title: "Tsomgo Lake", image: highlightImages[1], desc: "A sacred glacial lake at 12,400 ft, surrounded by snow-capped peaks." },
  { title: "Yumthang Valley", image: highlightImages[2], desc: "The 'Valley of Flowers' blooms with rhododendrons in spring." },
  { title: "Rumtek Monastery", image: highlightImages[3], desc: "One of the largest monasteries in Sikkim, seat of the Karmapa." },
  { title: "Kanchenjunga Views", image: rightSideImage, desc: "Breathtaking sunrise views of the world’s 3rd highest peak from Pelling." },
];
        ...
        >
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2" />
                <strong>Best Time:</strong> <span className="ml-1">Mar–Jun, Oct–Feb</span>
              </li>
            </ul>
          </div>
      ...
      >
        ...
        >
          <div>
            ...
            <p className="text-xl text-[#F5A623] font-bold">Starting at ₹24,999 per person</p>
            <p className="text-sm text-gray-600 mt-2 font-sans">*Prices vary by season & group size</p>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Flights/train to NJP/Bagdogra</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Lunch & personal expenses</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Nathula Pass permit fees</li>
        ...
        >
          <ul className="space-y-3 text-gray-700 font-sans">
            <li className="flex items-start">
              ...
              Nathula Pass is closed on Monday & Tuesday. Permit required (apply 24 hrs in advance).
            </li>
            <li className="flex items-start">
              <AiOutlineStar className="text-[#F5A623] mr-2 mt-1" />
              Zero Point & Yumthang in winter may be inaccessible due to snow. Alternate sightseeing provided.
            </li>
            <li className="flex items-start">
              <AiOutlineStar className="text-[#F5A623] mr-2 mt-1" />
              Carry warm clothes, sunscreen, and valid ID proof. High altitude — stay hydrated.
            </li>
            <li className="flex items-start">
              <AiOutlineStar className="text-[#F5A623] mr-2 mt-1" />
              Itinerary subject to change due to weather, road conditions, or government regulations.
            </li>
          </ul>
        </motion.div>
      </motion.section>
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              ...
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Sikkim Himalayan Escape</h3>
            </div>
