...
// === QUICK FACTS ===
const quickFacts = [
  { text: "Amber Fort is a UNESCO World Heritage Site built in 1592." },
  { text: "Ranthambore National Park is one of India's top tiger reserves." },
  { text: "Hawa Mahal has 953 small windows for royal ladies to observe street life." },
  { text: "Ranthambore Fort dates back to the 10th century and offers panoramic views." },
];
...
const itinerary = [
  {
    ...
    desc: "Morning: Arrive at Jaipur Airport/Railway Station; transfer to your hotel.\nAfternoon: Visit the iconic City Palace, the majestic Hawa Mahal, and the astronomical marvel Jantar Mantar.\nEvening: Optionally, visit the serene Birla Mandir.\nOvernight: Stay at a 3-star hotel in Jaipur."
  },
  {
    day: "Day 2",
    title: "Jaipur Sightseeing – Forts & Local Markets",
    desc: "Morning: Explore the grand Amber Fort, enjoy an optional elephant ride (subject to availability), and visit the Jal Mahal for a photo stop.\nAfternoon: Visit the Sheesh Mahal (Hall of Mirrors) and the Maharaja's City Palace.\nEvening: Free time to explore local markets or relax.\nOvernight: Stay at the same hotel in Jaipur."
  },
  {
    day: "Day 3",
    title: "Jaipur to Ranthambore – Wildlife Adventure",
    desc: "Morning: After breakfast, drive to Ranthambore (approx. 3.5 hours).\nAfternoon: Check-in at your resort; visit the historic Ranthambore Fort and the Trinetra Ganesh Temple.\nEvening: Leisure time to relax at the resort.\nOvernight: Stay at a resort in Ranthambore."
  },
  {
    day: "Day 4",
    title: "Ranthambore Safari & Departure",
    desc: "Early Morning: Embark on a thrilling Jeep Safari in Ranthambore National Park to spot the majestic Bengal tigers and other wildlife.\nAfternoon: Return to the resort for breakfast.\nEvening: Drive back to Jaipur; drop at Jaipur Airport/Railway Station for your onward journey."
  },
];

// === HIGHLIGHTS ===
const highlights = [
  { title: "Amber Fort", image: highlightImages[0], desc: "Majestic hilltop fort with optional elephant ride." },
  { title: "Tiger Safari", image: highlightImages[1], desc: "Jeep safari in Ranthambore National Park." },
  { title: "Hawa Mahal", image: highlightImages[2], desc: "Palace of Winds with 953 windows." },
  { title: "Ranthambore Fort", image: highlightImages[3], desc: "Ancient 10th-century fort inside the park." },
];

// === FAQs (Trip-Specific) ===
const faqs = [
  { question: "Is the safari guaranteed to spot tigers?", answer: "No wildlife sighting is guaranteed, but Ranthambore has one of the highest tiger densities in India. Early morning safaris offer the best chance." },
  { question: "What type of vehicle is used for safari?", answer: "Open-top 6-seater Jeep (shared). Private Jeep available at extra cost." },
  { question: "Is elephant ride included?", answer: "No, elephant ride at Amber Fort is optional and subject to availability. It is not included in the package." },
  { question: "What is the accommodation standard?", answer: "3-star hotel in Jaipur (twin/double sharing) and a comfortable resort in Ranthambore with modern amenities." },
  { question: "Are entry fees included?", answer: "Yes, entry fees to all mentioned monuments and one safari in Ranthambore are included." },
  { question: "Can we do two safaris?", answer: "Yes, additional safari can be booked at extra cost (subject to availability)." },
  { question: "What should I carry for safari?", answer: "Warm jacket (winter), cap/hat, sunscreen, binoculars, camera, ID proof, and water bottle." },
  { question: "Is the tour suitable for children?", answer: "Yes, family-friendly. Kids above 5 years are allowed in safari." },
  { question: "What is the best time to visit?", answer: "October to March. Park is closed during monsoon (July–September)." },
  { question: "Is travel insurance included?", answer: "No, we recommend purchasing comprehensive travel insurance separately." },
];
...
const importantInfo = [
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-1">
        <li><strong>Accommodation:</strong> 2 nights in Jaipur and 1 night in Ranthambore with breakfast and dinner.</li>
        <li><strong>Transportation:</strong> Private AC vehicle for all transfers and sightseeing.</li>
        <li><strong>Safari:</strong> 1 Jeep safari in Ranthambore National Park.</li>
        <li><strong>Sightseeing:</strong> All mentioned attractions with entry fees.</li>
        <li><strong>Meals:</strong> Breakfast and dinner as per itinerary.</li>
      </ul>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <p>
        <strong>Ideal Period:</strong> October to March<br />
        <em>Pleasant weather for sightseeing and high tiger sighting probability.</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Follow park rules during safari — no loud noise, no standing in jeep.</li>
        <li>Wear neutral-colored clothes during safari (avoid bright colors).</li>
        <li>Carry sunscreen, hat, and mosquito repellent.</li>
        <li>Keep a safe distance from wildlife.</li>
        <li>Emergency contact: Driver/Guide available throughout.</li>
      </ul>
    ),
  },
];
...
// === MAIN COMPONENT ===
export default function JaipurRanthamborePackage() {
  ...
  const handleSubmit = useCallback((e) => {
    e.preventDefault();
    console.log('Jaipur-Ranthambore Booking:', formData);
    handleCloseModal();
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#00453A]/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              3 Nights / 4 Days – Heritage & Wildlife
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Experience the royal grandeur of <strong>Jaipur</strong> and the wild thrill of <strong>Ranthambore</strong>. From majestic forts to tiger safaris, this 4-day journey blends heritage, culture, and wildlife.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Route:</strong> Jaipur → Ranthambore → Jaipur
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Safari:</strong> 1 Jeep Safari
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Best For:</strong> Heritage + Wildlife
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <Image
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Jaipur & Ranthambore – 3N/4D – Paradise Bliss</h3>
            </div>
